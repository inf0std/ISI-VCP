...
function PrgmConference() {
  return (
    <>
    <h1>Programmer une Débat</h1>
    <form>
      <div class="mb-3">
         <label for="exampleFormControlInput1" class="form-label">Sujet</label>
         <input type="text" class="form-control" id="exampleFormControlInput1"  placeholder='Entrez le sujet du débat'/>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
         <label for="exampleFormControlInput1" class="form-label">Débattre avec </label>
         <input type="text" class="form-control" id="exampleFormControlInput1" placeholder='Chercher une personne'/>
